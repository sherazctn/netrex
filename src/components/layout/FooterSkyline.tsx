...
export function FooterSkyline() {
  ...
  return (
    <div ref={ref} className="absolute bottom-0 left-0 right-0 h-56 pointer-events-none overflow-hidden">
      ...
      <motion.div style={{ x: x2 }} className="absolute bottom-0 left-0 right-0 h-full opacity-[0.08]">
      ...
      {/* Main layer - detailed landmarks */}
      <motion.div style={{ x: x1 }} className="absolute bottom-0 left-0 right-0 h-full opacity-[0.15]">
        <svg viewBox="0 0 1800 240" className="w-full h-full" preserveAspectRatio="xMidYMax slice" fill="currentColor">
          ...
          {/* Art deco arches */}
          <path d="M468,77 Q471,65 474,58" fill="none" stroke="currentColor" strokeWidth="1.5" />
          <path d="M484,77 Q481,65 478,58" fill="none" stroke="currentColor" strokeWidth="1.5" />
          
          {/* Flatiron hint */}
          <polygon points="505,240 510,120 520,240" />
          ...
          <polygon points="758,138 761,124 764,138" />
          <polygon points="786,138 789,124 792,138" />
          ...
          {/* Living Shangri-La */}
          <rect x="1060" y="58" width="12" height="182" rx="1" />
          <rect x="1063" y="50" width="6" height="12" />
          ...
          <rect x="1134" y="54" width="6" height="12" rx="1" />
          <rect x="1136" y="38" width="2" height="20" />
          
          {/* Harbour Bridge */}
          <path d="M1300 200 Q1320 148 1350 138 Q1380 148 1400 200" fill="none" stroke="currentColor" strokeWidth="4" />
          <rect x="1305" y="200" width="4" height="40" />
          <rect x="1390" y="200" width="4" height="40" />
