...
const serviceTechStacks: Record<string, {name: string;logo: string;size: string;}[]> = {
  ...
  { name: "Fastlane", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/fastlane.svg", size: "sm" }],
  ...
  { name: "InVision", logo: "https://www.google.com/s2/favicons?domain=invisionapp.com&sz=128", size: "md" },
  { name: "Principle", logo: "https://www.google.com/s2/favicons?domain=principleformac.com&sz=128", size: "sm" },
  { name: "Framer", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/framer.svg", size: "md" },
  { name: "Zeplin", logo: "https://www.google.com/s2/favicons?domain=zeplin.io&sz=128", size: "sm" },
  { name: "Marvel", logo: "https://www.google.com/s2/favicons?domain=marvelapp.com&sz=128", size: "sm" },
  { name: "Balsamiq", logo: "https://www.google.com/s2/favicons?domain=balsamiq.com&sz=128", size: "sm" },
  { name: "Miro", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/miro.svg", size: "md" },
  { name: "Webflow", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/webflow.svg", size: "sm" },
  { name: "Lottie", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/lottiefiles.svg", size: "sm" }],

  "digital-marketing": [
  { name: "Google Analytics", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/googleanalytics.svg", size: "lg" },
  { name: "Google Ads", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/googleads.svg", size: "lg" },
  { name: "Meta Ads", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/facebook/facebook-original.svg", size: "lg" },
  { name: "SEMrush", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/semrush.svg", size: "md" },
  { name: "Ahrefs", logo: "https://www.google.com/s2/favicons?domain=ahrefs.com&sz=128", size: "md" },
  { name: "Mailchimp", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/mailchimp.svg", size: "md" },
  { name: "HubSpot", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/hubspot.svg", size: "lg" },
  { name: "Hootsuite", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/hootsuite.svg", size: "sm" },
  { name: "Buffer", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/buffer.svg", size: "sm" },
  { name: "Moz", logo: "https://www.google.com/s2/favicons?domain=moz.com&sz=128", size: "md" },
  { name: "Hotjar", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/hotjar.svg", size: "sm" },
  { name: "Crazy Egg", logo: "https://www.google.com/s2/favicons?domain=crazyegg.com&sz=128", size: "sm" },
  { name: "Sprout Social", logo: "https://www.google.com/s2/favicons?domain=sproutsocial.com&sz=128", size: "sm" },
  { name: "Klaviyo", logo: "https://www.google.com/s2/favicons?domain=klaviyo.com&sz=128", size: "sm" },
  { name: "LinkedIn Ads", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/linkedin.svg", size: "md" }],
  ...
  { name: "InDesign", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/adobeindesign.svg", size: "lg" },
  ...
  { name: "Canva", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/canva.svg", size: "md" },
  { name: "Procreate", logo: "https://www.google.com/s2/favicons?domain=procreate.com&sz=128", size: "sm" },
  { name: "Premiere Pro", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/adobepremierepro.svg", size: "md" },
  ...
  { name: "Lightroom", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/adobelightroom.svg", size: "sm" },
  { name: "CorelDRAW", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/coreldraw.svg", size: "sm" },
  { name: "Adobe XD", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/xd/xd-plain.svg", size: "md" },
  { name: "Webflow", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/webflow.svg", size: "sm" },
  { name: "Lottie", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/lottiefiles.svg", size: "sm" }],

  "ecommerce": [
  { name: "Shopify", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/shopify.svg", size: "lg" },
  { name: "WooCommerce", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/woocommerce.svg", size: "lg" },
  { name: "Magento", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/magento.svg", size: "md" },
  { name: "BigCommerce", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/bigcommerce.svg", size: "md" },
  { name: "Stripe", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/stripe.svg", size: "lg" },
  { name: "PayPal", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/paypal.svg", size: "md" },
  ...
  { name: "Square", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/square.svg", size: "sm" },
  { name: "Razorpay", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/razorpay.svg", size: "sm" },
  ...
  { name: "Algolia", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/algolia.svg", size: "sm" }],
  ...
  { name: "LangChain", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/langchain.svg", size: "md" },
  { name: "Hugging Face", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/huggingface.svg", size: "md" },
  ...
  { name: "Scikit-learn", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/scikitlearn.svg", size: "md" },
  ...
  { name: "Keras", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/keras.svg", size: "sm" },
  { name: "MLflow", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/mlflow.svg", size: "sm" },
  { name: "Anthropic", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/anthropic.svg", size: "md" }],
  ...
  { name: "Ahrefs", logo: "https://www.google.com/s2/favicons?domain=ahrefs.com&sz=128", size: "md" },
  { name: "SEMrush", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/semrush.svg", size: "md" },
  { name: "Perplexity", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/perplexity.svg", size: "lg" },
  { name: "Claude", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/anthropic.svg", size: "md" },
  { name: "Schema.org", logo: "https://www.google.com/s2/favicons?domain=schema.org&sz=128", size: "sm" },
  { name: "Moz", logo: "https://www.google.com/s2/favicons?domain=moz.com&sz=128", size: "md" },
  { name: "Screaming Frog", logo: "https://www.google.com/s2/favicons?domain=screamingfrog.co.uk&sz=128", size: "sm" },
  { name: "Google Analytics", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/googleanalytics.svg", size: "md" },
  { name: "Google Search Console", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/googlesearchconsole.svg", size: "md" },
  { name: "WordPress", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/wordpress/wordpress-plain.svg", size: "sm" },
  { name: "Yoast", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/yoast.svg", size: "sm" },
  { name: "ChatGPT", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/openai.svg", size: "lg" },
  { name: "Clearscope", logo: "https://www.google.com/s2/favicons?domain=clearbit.com&sz=128", size: "sm" }],
  ...
  { name: "CircleCI", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/circleci.svg", size: "sm" },
  { name: "ArgoCD", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/argo.svg", size: "sm" }]
