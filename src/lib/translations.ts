...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.description': 'We empower businesses to innovate, optimize, and scale with cutting-edge digital solutions across 6 countries.',
    ...
    'contact.description': 'With offices across 6 countries, we\'re always nearby. Select your region to get local contact information.',
    'contact.phone': 'Phone',
    'contact.email': 'Email',
  ...
  ar: {
    ...
    'hero.description': 'نمكّن الشركات من الابتكار والتحسين والتوسع من خلال حلول رقمية متطورة في 6 دول.',
    ...
    'contact.description': 'مع مكاتب في 6 دول، نحن دائماً بالقرب منك. اختر منطقتك للحصول على معلومات الاتصال المحلية.',
  ...
  zh: {
    ...
    'hero.description': '我们帮助企业通过尖端数字解决方案进行创新、优化和扩展，业务覆盖6个国家。',
    ...
    'contact.description': '我们在6个国家设有办事处，随时为您服务。选择您的地区获取当地联系信息。',
    'contact.phone': '电话',
    'contact.email': '电子邮件',
    'contact.address': '地址',
    'contact.hours': '工作时间',
  ...
  fr: {
    ...
    'hero.description': 'Nous permettons aux entreprises d\'innover, d\'optimiser et de se développer grâce à des solutions numériques de pointe dans 6 pays.',
    ...
    'contact.description': 'Avec des bureaux dans 6 pays, nous sommes toujours proches. Sélectionnez votre région pour les informations de contact locales.',
  ...
  es: {
    ...
    'hero.description': 'Empoderamos a las empresas para innovar, optimizar y escalar con soluciones digitales de vanguardia en 6 países.',
    ...
    'contact.description': 'Con oficinas en 6 países, siempre estamos cerca. Selecciona tu región para información de contacto local.',
  ...
  de: {
    ...
    'hero.description': 'Wir befähigen Unternehmen, mit modernsten digitalen Lösungen in 6 Ländern zu innovieren, zu optimieren und zu skalieren.',
    ...
    'contact.description': 'Mit Büros in 6 Ländern sind wir immer in Ihrer Nähe. Wählen Sie Ihre Region für lokale Kontaktinformationen.',
  ...
  ru: {
    ...
    'hero.description': 'Мы помогаем бизнесу внедрять инновации, оптимизировать и масштабировать с помощью передовых цифровых решений в 6 странах.',
    ...
    'contact.description': 'С офисами в 6 странах мы всегда рядом. Выберите регион для местной контактной информации.',
  ...
  pt: {
    ...
    'hero.description': 'Capacitamos empresas a inovar, otimizar e escalar com soluções digitais de ponta em 6 países.',
    ...
    'contact.description': 'Com escritórios em 6 países, estamos sempre por perto. Selecione sua região para informações de contato locais.',
  ...
  ja: {
    ...
    'hero.description': '6か国にわたる最先端のデジタルソリューションで、ビジネスの革新、最適化、スケーリングを支援します。',
    ...
    'contact.description': '6か国にオフィスを構え、常にお近くにいます。地域を選択してローカルの連絡先情報を取得してください。',
    'contact.phone': '電話',
    'contact.email': 'メール',
    'contact.address': '住所',
    'contact.hours': '営業時間',
